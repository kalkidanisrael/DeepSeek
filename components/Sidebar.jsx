    ...
    >
      <div>
        ...
        <div
          ...
          className="group relative flex items-center justify-center hover:bg-gray-500/20 transition-all duration-300 h-9 aspect-square rounded-lg cursor-pointer"
        >
          ...
          />
          <div
            className={`absolute w-max ${expand ? "eft-1/2 -translate-x-1/2 top-12" : "-top-12 left-0 opacity-0 group-hover:opacity-100 transition bg-black text-white text-sm px-3 py-2 rounded-lg shadow-lg pointer-events-none"}`}
          >
        ...
        <div className={`flex items-center cursor-pointer group relative ${expand? "gap-1 text-white/80 text-sm p-2.5 border border-primary rounded-lg hover:bg-white/10 cursor-pointer":"h-10 w-10 mx-auto hover:bg-gray-500/30 rounded-lg"}`}>
          ...
          <div className={`absolute -top-60 pb-8 ${!expand &&"-right-40" } opacity-0 group-hover:opacity-100 group-hover:block transition`}>
            <div className="relative w-max bg-black text-white text-sm p-3 rounded-lg shadow-lg">
              ...
              <p>Scan to get DeeSeek App</p>
              <div
                className={`1w-3 h-3 absolute bg-black rotate-45 ${expand ? "right-1/2" : "left-4"} -bottom-1.5`}
              ></div>
            </div>
          </div>
                  {expand && (
